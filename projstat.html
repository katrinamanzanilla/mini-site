  ...
  <main class="content status-page">
    <div class="status-shell">
      <section class="status-top">
        ...
        <p class="status-intro">Paste one Google link (Google Sheets, Drive, Docs, Forms, or Apps Script), then click <strong>VIEW DASHBOARD</strong>.</p>
        <form id="sheet-source-form" class="status-source-form" autocomplete="off">
          ...
          <div class="status-source-row">
            <input id="sheet-source-input" class="status-source-input" type="text" placeholder="Paste your Google link here" required>
            <button type="submit" id="use-file-button" class="drive-button">VIEW DASHBOARD</button>
      ...
      <section class="status-grid" aria-label="Project status details">
        ...
        <article class="status-panel">
          <div class="panel-title-row">
            <h2 class="tracker-panel-title">Status Snapshot</h2>
          </div>
          <ul class="status-list" id="status-snapshot-list">
        ...
        <article class="status-panel">
          <div class="panel-title-row">
            <h2 class="tracker-panel-title">Timeline</h2>
          </div>
          <ul class="status-list" id="timeline-list">
        ...
        <article class="status-panel full-width">
          <div class="panel-title-row">
            <h2 class="tracker-panel-title">Inserted Link History</h2>
            <span class="layout-note">Latest links loaded into dashboard</span>
          </div>
          <div class="sheet-preview-wrap">
            <table class="issues-table">
              ...
              <tbody id="link-history-body"></tbody>
            </table>
          </div>
        </article>
